...
If you discover a security vulnerability in TiRoute, please report it responsibly:

1. **DO NOT** open a public GitHub issue
2. Use [GitHub Security Advisories](https://github.com/diegosouzapw/TiRoute/security/advisories/new)
...
TiRoute implements a multi-layered security model:
